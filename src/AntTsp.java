...
//            return;
//        }
        AntTsp[] anttsp = new AntTsp[]{new AntTsp(),new AntTsp(),new AntTsp(),new AntTsp(),new AntTsp(),};
        try {
      //      anttsp.readGraph(args[0]);
        	for(int i=0;i<anttsp.length;i++){
        		
        		anttsp[i].readGraph("/Users/jerbluba/modtest"+i+".txt");
        	}
            
//            anttsp.readGraph("C:\\Users\\jerjerjer\\Desktop\\vrp\\vrp\\演算法\\ant-tsp-master\\tspadata1.txt");
// anttsp.readGraph("/Users/jerbluba/Desktop/ex1.txt");
//        	 anttsp.readGraph("/Users/jerbluba/Desktop/tspadata2.txt");
        } catch (IOException e) {
...
for(int i=0;i<anttsp.length-1;i++){
